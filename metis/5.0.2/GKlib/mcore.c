...
\version $Id: mcore.c 10711 2011-08-31 22:23:04Z karypis $
*/
  ...
  while (mcore->cmop > 0) {
    ...
    switch (mcore->mops[mcore->cmop].type) {
      ...
      case GK_MOPT_CORE: /* core free */
        ...
        // FIXME: The following triggers a clang warning (tautological-compare)
        // because mcore->corecpos is unsigned...
        /*
          if (mcore->corecpos < 0)
